...
if __name__ == '__main__':
    ...
    D3_1=np.transpose(readFile('Qin_et_al_2024_TAU2.txt'))
    D4_1=np.transpose(readFile('Khaled_et_al_2020_TAU2.txt'))
    D5_1=np.transpose(readFile('paper_algorithm2_TAU2.txt'))
    D6_1=np.transpose(readFile('Mitra_et_al_2021b_TAU2.txt'))
    D7_1=np.transpose(readFile('Mukherjee_et_al_2024_TAU2.txt'))
   ...
   #Next
    ...
    D3_2=np.transpose(readFile('Qin_et_al_2024_TAU3.txt'))
    D4_2=np.transpose(readFile('Khaled_et_al_2020_TAU3.txt'))
    D5_2=np.transpose(readFile('paper_algorithm2_TAU3.txt'))
    D6_2=np.transpose(readFile('Mitra_et_al_2021b_TAU3.txt'))
    D7_2=np.transpose(readFile('Mukherjee_et_al_2024_TAU3.txt'))
   ...
   #Next
    ...
    D3_3=np.transpose(readFile('Qin_et_al_2024_TAU4.txt'))
    D4_3=np.transpose(readFile('Khaled_et_al_2020_TAU4.txt'))
    D5_3=np.transpose(readFile('paper_algorithm2_TAU4.txt'))
    D6_3=np.transpose(readFile('Mitra_et_al_2021b_TAU4.txt'))
    D7_3=np.transpose(readFile('Mukherjee_et_al_2024_TAU4.txt'))
   ...
   #Next
    ...
    D3_4=np.transpose(readFile('Qin_et_al_2024_TAU5.txt'))
    D4_4=np.transpose(readFile('Khaled_et_al_2020_TAU5.txt'))
    D5_4=np.transpose(readFile('paper_algorithm2_TAU5.txt'))
    D6_4=np.transpose(readFile('Mitra_et_al_2021b_TAU5.txt'))
    D7_4=np.transpose(readFile('Mukherjee_et_al_2024_TAU5.txt'))
   ...
   #Next
    ...
    D3_5=np.transpose(readFile('Qin_et_al_2024_TAU6.txt'))
    D4_5=np.transpose(readFile('Khaled_et_al_2020_TAU6.txt'))
    D5_5=np.transpose(readFile('paper_algorithm2_TAU6.txt'))
    D6_5=np.transpose(readFile('Mitra_et_al_2021b_TAU6.txt'))
    D7_5=np.transpose(readFile('Mukherjee_et_al_2024_TAU6.txt'))
