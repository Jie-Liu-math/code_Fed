...
np.savetxt('Qin_et_al_2024_TAU2.txt',Result_my3,fmt="%f",delimiter=" ")
np.savetxt('Mukherjee_et_al_2024_TAU2.txt',Result_my4,fmt="%f",delimiter=" ") 
np.savetxt('Khaled_et_al_2020_TAU2.txt',Result_my5,fmt="%f",delimiter=" ")
np.savetxt('paper_algorithm2_TAU2.txt',Result_my6,fmt="%f",delimiter=" ") 
np.savetxt('Mitra_et_al_2021b_TAU2.txt',Result_my7,fmt="%f",delimiter=" ") 
...
#np.savetxt('Qin_et_al_2024_TAU3.txt',Result_my3,fmt="%f",delimiter=" ")
#np.savetxt('Mukherjee_et_al_2024_TAU3.txt',Result_my4,fmt="%f",delimiter=" ") 
#np.savetxt('Khaled_et_al_2020_TAU3.txt',Result_my5,fmt="%f",delimiter=" ")
#np.savetxt('paper_algorithm2_TAU3.txt',Result_my6,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU3.txt',Result_my7,fmt="%f",delimiter=" ") 
...
#np.savetxt('Qin_et_al_2024_TAU4.txt',Result_my3,fmt="%f",delimiter=" ")
#np.savetxt('Mukherjee_et_al_2024_TAU4.txt',Result_my4,fmt="%f",delimiter=" ") 
#np.savetxt('Khaled_et_al_2020_TAU4.txt',Result_my5,fmt="%f",delimiter=" ")
#np.savetxt('paper_algorithm2_TAU4.txt',Result_my6,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU4.txt',Result_my7,fmt="%f",delimiter=" ") 
...
#np.savetxt('Qin_et_al_2024_TAU5.txt',Result_my3,fmt="%f",delimiter=" ")
#np.savetxt('Mukherjee_et_al_2024_TAU5.txt',Result_my4,fmt="%f",delimiter=" ") 
#np.savetxt('Khaled_et_al_2020_TAU5.txt',Result_my5,fmt="%f",delimiter=" ")
#np.savetxt('paper_algorithm2_TAU5.txt',Result_my6,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU5.txt',Result_my7,fmt="%f",delimiter=" ") 
...
#np.savetxt('Qin_et_al_2024_TAU6.txt',Result_my3,fmt="%f",delimiter=" ")
#np.savetxt('Mukherjee_et_al_2024_TAU6.txt',Result_my4,fmt="%f",delimiter=" ") 
#np.savetxt('Khaled_et_al_2020_TAU6.txt',Result_my5,fmt="%f",delimiter=" ")
#np.savetxt('paper_algorithm2_TAU6.txt',Result_my6,fmt="%f",delimiter=" ") 
#np.savetxt('Mitra_et_al_2021b_TAU6.txt',Result_my7,fmt="%f",delimiter=" ") 